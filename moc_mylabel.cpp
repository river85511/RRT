...
#include "../Desktop/RRT-clone/mylabel.h"
...
QT_MOC_LITERAL(1, 8, 12), // "mousePressed"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 1), // "x"
QT_MOC_LITERAL(4, 24, 1), // "y"
QT_MOC_LITERAL(5, 26, 11) // "leftOrRight"

    },
    "myLabel\0mousePressed\0\0x\0y\0leftOrRight"
};
...
void myLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mousePressed((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< bool(*)>(_a[3]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myLabel::mousePressed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myLabel::mousePressed(int _t1, int _t2, bool _t3)
{
